    ...
    return (
        ...
        >
            <Card className={`h-full transition-all duration-700 cursor-pointer relative overflow-hidden ${color.border} ${isHovered ? color.hoverBorder : color.border} ${isHovered ? `shadow-xl ${color.shadow}` : "shadow-md"} ${isHovered ? color.bg : "bg-white"} hover:shadow-2xl`}>
                ...
                <motion.div
                    className={`absolute top-0 right-0 w-20 h-20 bg-gradient-to-bl ${gradient} opacity-0 group-hover:opacity-20 transition-opacity duration-500`}
                ...
                <motion.div
                    className={`absolute inset-0 bg-gradient-to-r ${gradient} rounded-lg opacity-0 group-hover:opacity-10 transition-opacity duration-700 blur-xl`}
                    animate={
                        isHovered
